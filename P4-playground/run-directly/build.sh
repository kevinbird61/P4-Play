...
sudo ip netns exec h1 ip link set h1-eth0 address 00:00:00:00:01:01
...
sudo ip netns exec h2 ip link set h2-eth0 address 00:00:00:00:02:02
...
sudo ip netns exec s1 sysctl net.ipv6.conf.s1-eth1.disable_ipv6=1
sudo ip netns exec s1 sysctl net.ipv6.conf.s1-eth2.disable_ipv6=1
