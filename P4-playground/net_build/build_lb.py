...
class multiSwitchTopo(Topo):
    def __init__(self, sw_path, json_path, thrift_port, pcap_dump, **opts):
        ...
        # make sure s1-eth4 = port 4
        self.addLink(h11,s1,addr1='00:04:00:00:00:11',addr2='00:aa:bb:00:01:11',intfName1="eth0",intfName2="s1-eth4")
...
def main():
    ...
    h11 = net.get('h11')
    h11.setARP("10.0.1.1","00:aa:bb:00:01:11")
